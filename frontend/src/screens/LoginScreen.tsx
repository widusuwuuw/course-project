...
const loginCarouselImages = [
  ...
  {
    id: 1,
    source: require('../../assets/images/fitness-tracking.jpg'),
    title: '科学运动追踪',
    subtitle: '个性化健身计划与数据分析'
  },
  {
    id: 2,
    source: require('../../assets/images/nutrition-management.jpg'),
    title: '精准营养管理',
    subtitle: '科学饮食搭配，健康生活每一天'
  },
  {
    id: 3,
    source: require('../../assets/images/meditation-wellness.jpg'),
    title: '身心平衡管理',
      ...
      >
        ...
        <Animated.View style={[styles.rightPanel, { backgroundColor }]}>
          ...
          <View style={styles.carouselContainer}>
            {/* 高质量轮播图片 */}
            <Animated.Image
              source={loginCarouselImages[currentImageIndex].source}
              style={[
